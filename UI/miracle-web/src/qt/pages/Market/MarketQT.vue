<template>
  <v-container>
    <v-row style="margin-bottom: 5%; align-items: center; justify-content: center;">
      ...
      >
        <product-card :productProp="product" :isMarketItemProp="true" @purchase="purchase($event)" />
      </v-col>
    </v-row>
...
import CheckOut from "../Market/CheckOutQT";
  ...
  methods: {
    ...
    async purchase(product) {
      ...
      if (response) {
        ...
        this.componentProps = { ordersProp: orders, totalPriceProp: product.price };
